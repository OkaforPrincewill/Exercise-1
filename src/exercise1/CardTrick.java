...
public class CardTrick {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < hand.length; i++) {
           ...
           card.setValue(rand.nextInt(13) + 1);
            ...
            hand[i] = new Card( Card.SUITS[suitIndex]);
        ...
        int pickValue = sc.nextInt();
        System.out.print("Suit: ");
        sc.nextLine();
        String pickSuit = sc.nextLine();

        boolean found = false;
        for (int i = 0; i < 7; i++) {
            if (hand[i].getValue() == pickValue && hand[i].getSuit() == pickSuit) {
    ...
    private static void printInfo() {
        ...
        System.out.println("My name is Princewill, but you can call me Prince");
        System.out.println();
